 ...
 */
	Configure::write('Session', array(
		'defaults' => 'php',
		'timeout'  => time() + (20 * 365 * 24 * 60 * 60),  // 4 hours 
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'KJHDFKJshaui34y5sjhfdskjhJHEFHJBFMDSNBVjhsdidfu98435');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '234576213863219873462879312987641293');
